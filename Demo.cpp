...
int main() {
    ...
    ///////////Extra tests///////////
    cout<<game_1.turn()<<endl; // Expected: Yossi
    cout<<judge.coins()<<endl; // Expected: 5
    cout<<spy.coins()<<endl; // Expected: 4
    spy.arrest(judge); // Spy arrest judge
    cout<<judge.coins()<<endl; // Expected: 4
    cout<<spy.coins()<<endl; // Expected: 5

    cout<<game_1.lastArrested()<<endl; // Expected: Gilad



    ///need to add more tests for the rest of the players
    // need to try arradst on the same player twice
